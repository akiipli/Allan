...
All must be done. Other problems with scaling and rotation. Maybe needs hierarchical chains system. Submitted into Trips Code folder Scenes IK b to serve as testfile. This file opens only in IK project.
