...
All must be done. Maybe needs hierarchical chains system. Submitted into Trips Code folder Scenes IK b to serve as testfile. This file opens only in IK project.
