        ...
        if (strcmp("Materials\n", buff) == 0)
        {
            ...
            for (m = 0; m < materials_count; m ++)
            {
                ...
                *p = '\0';
                ...
                sprintf(M->Texture_Name, "%s", buff);

                //
#if DEBUG_WITHOUT_IL == 0
                texture = load_ILU_image(M->Texture_Name);
#else
                ...
                if (texture != NULL)
                {
                    ...
                    memcpy(Text_Names[Surf_Text_c], basename(M->Texture_Name), strlen(basename(M->Texture_Name)));
                    Surf_Text_c ++;
                ...
                sscanf(buff, "%f %f %f %f", &M->R, &M->G, &M->B, &M->A);
