...
struct object
{
    ...
    GLuint vert_array_buffer;
    GLuint cols_array_buffer;
    GLuint norm_array_buffer;
    GLuint text_array_buffer;

    GLfloat * vert_array_[SUBD];
    GLfloat * cols_array_[SUBD];
    GLfloat * norm_array_[SUBD];
    GLfloat * text_array_[SUBD];

    int vert_array_size_[SUBD];
    int cols_array_size_[SUBD];
    int norm_array_size_[SUBD];
    int text_array_size_[SUBD];

    GLuint vert_array_buffer_[SUBD];
    GLuint cols_array_buffer_[SUBD];
    GLuint norm_array_buffer_[SUBD];
    GLuint text_array_buffer_[SUBD];
